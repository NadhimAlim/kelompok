<section class="bg-customBlue">
  <div class="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    <h2 class="text-center text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
      Apa Kata Mereka Tentang Destinasi Wisata
    </h2>
        ...
        <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="mt-0.5 text-lg font-medium text-gray-900">Andi, Jakarta</p>
            </div>
          </div>
        ...
        <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="mt-0.5 text-lg font-medium text-gray-900">Karno, Bandung</p>
            </div>
          </div>
        ...
        <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="mt-0.5 text-lg font-medium text-gray-900">Joko, Jogjakarta</p>
            </div>
          </div>
        ...
        <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="mt-0.5 text-lg font-medium text-gray-900">Santi, Semarang</p>
            </div>
          </div>
        ...
        <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="mt-0.5 text-lg font-medium text-gray-900">Sinta, Surabaya</p>
            </div>
          </div>
